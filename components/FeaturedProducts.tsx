...
export function FeaturedProducts() {
  return (
    <aside className="glass-card soft-ring w-full max-w-sm rounded-2xl p-6 text-beigeLight lg:max-w-xs">
      <p className="mb-4 text-xs uppercase tracking-[0.22em] text-goldAccent">Tanlangan mahsulotlar</p>
      <ul className="space-y-4">
        {products.map((product) => (
          ...
          >
            ...
            <span className="font-semibold text-goldAccent">{product.price}</span>
          </li>
        ))}
      </ul>
      <button
